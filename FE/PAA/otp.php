...
if (isset($_POST["sendotp"])) {
    ...
    if ($response["status"]) {
        header("Location: https://rdpkriss.krissstudio.com/PAA/FE/PAA/signin.php"); // Ubah lokasi sesuai yg kalian ingin\
    }
    else {
...
if (isset($_POST["loginotp"])) {
    ...
    $response = json_decode($result, true);
    if ($response["status"]) {
        header("Location: https:/rdpkriss.krissstudio.com/PAA\app\src\product\screen/index.php"); // Ubah lokasi sesuai yg kalian ingin\
    }
    else {
   ...
   exit;
    // header("Location: https://rdpkriss.krissstudio.com/PAA/FE/PAA/signin.php"); 
}
?>